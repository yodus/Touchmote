...
namespace WiiTUIO.Provider
{
    ...
    public class WiiKeyMapper
    {
        ...
        public Keymap loadKeyMap(string filename)
        {
            ...
            PressedButtons = ~ButtonFlag.Home;
        ...
        public bool processWiimoteState(WiimoteState wiimoteState) //Returns true if anything has changed from last report.
        {
            ...
            if(wiimoteState.Extension && wiimoteState.ExtensionType == ExtensionType.Nunchuk)
            {
                ...
                significant |= checkButtonUpOrDown(wiimoteState.NunchukState.C, "Nunchuk.C");
                significant |= checkButtonUpOrDown(wiimoteState.NunchukState.Z, "Nunchuk.Z");
            }
            ...
            if (wiimoteState.Extension && wiimoteState.ExtensionType == ExtensionType.ClassicController)
            {
                ...
                significant |= checkButtonUpOrDown(classicButtonState.A , "Classic.A");
                significant |= checkButtonUpOrDown(classicButtonState.B, "Classic.B");
                significant |= checkButtonUpOrDown(classicButtonState.Down, "Classic.Down");
                significant |= checkButtonUpOrDown(classicButtonState.Home, "Classic.Home");
                significant |= checkButtonUpOrDown(classicButtonState.Left, "Classic.Left");
                significant |= checkButtonUpOrDown(classicButtonState.Minus, "Classic.Minus");
                significant |= checkButtonUpOrDown(classicButtonState.Plus, "Classic.Plus");
                significant |= checkButtonUpOrDown(classicButtonState.Right, "Classic.Right");
                significant |= checkButtonUpOrDown(classicButtonState.TriggerL, "Classic.L");
                significant |= checkButtonUpOrDown(classicButtonState.TriggerR, "Classic.R");
                significant |= checkButtonUpOrDown(classicButtonState.Up, "Classic.Up");
                significant |= checkButtonUpOrDown(classicButtonState.X, "Classic.X");
                significant |= checkButtonUpOrDown(classicButtonState.Y, "Classic.Y");
                significant |= checkButtonUpOrDown(classicButtonState.ZL, "Classic.ZL");
                significant |= checkButtonUpOrDown(classicButtonState.ZR, "Classic.ZR");
            }
            ...
            significant |= checkButtonUpOrDown(buttonState.A, "A");
            significant |= checkButtonUpOrDown(buttonState.B, "B");
            significant |= checkButtonUpOrDown(buttonState.Down, "Down");
            significant |= checkButtonUpOrDown(buttonState.Home, "Home");
            significant |= checkButtonUpOrDown(buttonState.Left, "Left");
            significant |= checkButtonUpOrDown(buttonState.Minus, "Minus");
            significant |= checkButtonUpOrDown(buttonState.One, "One");
            significant |= checkButtonUpOrDown(buttonState.Plus, "Plus");
            significant |= checkButtonUpOrDown(buttonState.Right, "Right");
            significant |= checkButtonUpOrDown(buttonState.Two, "Two");
            significant |= checkButtonUpOrDown(buttonState.Up, "Up");
        ...
        private bool checkButtonUpOrDown(bool pressedNow, string buttonName)
        {
            bool significant = false;
